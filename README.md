...
1. Start MongoDB
Ensure your local MongoDB server is running. By default, the app connects to:
```
mongodb://localhost:27017/projectDB
```
2. Start Backend Server (inside /backend)
```
node server.js
```
